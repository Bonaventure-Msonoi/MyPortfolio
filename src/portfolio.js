...
const seo = {
  title: "Bonaventure's Portfolio",
  description:
    "A passionate individual who always thrives to work on end to end products which develop sustainable and scalable social and technical systems to create impact.",
  og: {
    title: "Bonaventure M'sonoi Portfolio",
    type: "website",
    url: "http://www.facebook.com/bonaventure.msonoi",
  },
};
...
const socialMediaLinks = [
  ...
  {
    name: "LinkedIn",
    link: "https://www.linkedin.com/in/bonaventure.msonoi/",
  ...
  {
    name: "Gmail",
    link: "mailto:bonaventuremsonoi@gmail.com",
    fontAwesomeIcon: "fa-google", // Reference https://fontawesome.com/icons/google?style=brands
    backgroundColor: "#D14836", // Reference https://simpleicons.org/?q=gmail
  },
  {
    name: "X-Twitter",
    link: "https://twitter.com/BMsonoi",
  ...
  data: [
    {
      ...
      skills: [
        ...
        "⚡ Experience of working with data analysis and optimisation models",
    ...
    },
    {
      ...
      skills: [
        ...
        // "⚡ not yet Deploying deep learning models on cloud to use on mobile devices",
...
const experience = {
  ...
  sections: [
      ...
      experiences: [
        {
          ...
          location: " Makeni Bonaventure,Lusaka, ZM",
          description:
            "Building new mobile app features and website maintainance",
          color: "#000000",
        },
        {
    ...
    {
      title: "Volunteerships/Outreach Programs",
      experiences: [
        {
          title: "Computer Studies tutor",
          company: "kings Intenational private School",
          company_url: "",
          logo_path: "google_logo.png",
          duration: "sept 2022 - dec 2022",
          location: " 10miles area, Mungule Rd, off Great North Rd, Chibombo, Central Province",
          description:
            "enculcating basic important knowledge into the upcomming generation through giving back to the community.",
          color: "#4285F4",
        },
        // {
...
const publicationsHeader = {
  title: "Publications",
  description:
    "I have worked on  projects but haven't yet published all the research papers.",
  avatar_image_path: "projects_image.svg",
};
...
const contactPageData = {
  ...
  addressSection: {
    title: "Address",
    subtitle:
      "Africa, Zambia, Lusaka, Emmasdale, Madiba street",
    locality: "Globe",
    country: "ZM",
    region: "Lusaka",
    postalCode: "10101",
    streetAddress: "madiba street",
